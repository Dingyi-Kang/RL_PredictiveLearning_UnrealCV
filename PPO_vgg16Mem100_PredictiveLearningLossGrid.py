...
class Buffer:
    ...
    def finish_trajectory(self, last_value=0):
        ...
        self.trajectory_starts_buffer[trajectory_start_index] = 1
...
@tf.function
def sample_action_may_train_prediction(observation, hidden_state, duplicateFrames):
...
for epoch in range(epochs):
    ...
    for t in range(steps_per_epoch):
        ...
        logits, action, lossGrid, new_hidden_state = sample_action_may_train_prediction(reshaped_stacked_frames, hidden_state, duplicateFrames)
        ...
        if terminal or (t == steps_per_epoch - 1):
            ...
            if not done:
                reshaped_stacked_frames = stacked_frames.reshape(1, *stacked_frames.shape)
                _, _, lossGrid, _ = sample_action_may_train_prediction(reshaped_stacked_frames, hidden_state, duplicateFrames) 

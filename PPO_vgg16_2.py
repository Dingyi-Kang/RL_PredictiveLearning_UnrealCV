...
def create_cnn(observation_dimensions, num_actions):
    ...
    # Create a new model that outputs the results of the 4th block of VGG16
    vgg16_4blocks = keras.Model(inputs=vgg16_model.input, outputs=vgg16_model.get_layer('block4_pool').output)
    
    # We set the layers of vgg16_4blocks to be not trainable
    ...
    # Flatten the output of the TimeDistributed vgg16_4blocks model
...
dir_path = 'tmpVgg4BlocksSmallMem/checkpoints'
f = open('PPO_records_vgg4BlocksSmallMem.txt', 'a')
